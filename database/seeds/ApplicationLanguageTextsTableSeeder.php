     ...
     public function run()
     {
         ...
         */
         $textsTR = [   'id_Required' => 'gerekli',
                        ...
                        'id_CellDM'  => 'Her yüz kişide olan Cep telefon sayısı<p>Birleşmis Milletler (BM) Environment (çevre) ve infrastructure (altyapı) göstergeleri bölumü',
                        'id_RandDDM'  => 'Araştırma ve Geliştirme Harcaması<p>-- % of GDP (Yıllık Toplam Gelire Oranı)<p>Environment (çevre) ve infrastructure (altyapı) göstergeleri bölumü',
                        'id_InternetDM'  => 'Kişilerin İnternet kullanımı <p>-- Her 100 kişi oranı<p>Birleşmis Milletler (BM) Environment (çevre) ve infrastructure (altyapı) göstergeleri bölumü',
                        'id_SexRatioDM'  => 'Kadın oranı<p>-- her yüz kadına kaç erkek var<p>Birleşmis Milletler (BM) General Information (Genel Bilgi bölumü)',
         ...
         $textsSK = [   'id_Required' => 'požadovaný',
                        ...
                        'id_SexRatioDM'  => 'Pomer pohlavia<p>-- muž na 100 žien<p>Všeobecné informácie',
        ...
        $textsUSA = [   'id_Required' => 'required',
                        ...
                        'id_SexRatioDM'  => 'Sex ratio<p>-- male per 100 female<p>United Nations (UN) General Information',
